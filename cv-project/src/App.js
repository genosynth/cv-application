...
if(localStorage.getItem("cvapp")){
   ...
   const result = storage.experience.filter(el => el.companyName!==null );
   storage.experience = result
    ...
    return (
      <div className="main">
        ...
        <Header
          ...
          storingInfo={this.state.storedInfo}
          resetInfo={this.resetInfo}
          state={this.state}
        ></Header>
        <Education
          updateSchoolName={this.updateSchoolName}
          updateStudyName={this.updateStudyName}
          updateStudyDateFrom={this.updateStudyDateFrom}
          updateStudyDateTo={this.updateStudyDateTo}
        ...
        <Experience
          ...
          updatePositionTitle={this.updatePositionTitle}
          updateMainTasks={this.updateMainTasks}
          updateWorkDateFrom={this.updateWorkDateFrom}
          updateWorkDateTo={this.updateWorkDateTo}
